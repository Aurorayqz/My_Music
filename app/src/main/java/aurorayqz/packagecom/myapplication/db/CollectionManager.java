package aurorayqz.packagecom.myapplication.db;

import java.util.ArrayList;
import java.util.List;

import aurorayqz.packagecom.myapplication.data.CollectionBean;
import aurorayqz.packagecom.myapplication.data.CollectionShipBean;
import aurorayqz.packagecom.myapplication.data.Song;
import aurorayqz.packagecom.myapplication.db.dao.CollectionDao;
import aurorayqz.packagecom.myapplication.db.dao.CollectionShipDao;
